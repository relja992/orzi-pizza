    ...
    <div class="row"><br><br><br><br><br>
    	<div class="col-md-8 col-md-offset-2">
	        ...
	        <div class="col-md-6 col-md-offset-3" id="hiddenDiv" style="text-align:center; border-style:solid; border-width:1px; margin-top:20px">
                <h4>Ukupno</h4>
                <div class="form-group">
                    <span id="ukupnaCena" class="label label-warning"><?php echo e(Cart::subtotal()); ?></span>
                </div>
                <a href="<?php echo e(route('shipping')); ?>" id="submit-button" class="btn btn-success" style="width:80%">Podaci za dostavu</a>
                <br><br>
            </div><br><br><br><br>
        </div>
    </div><br><br>
