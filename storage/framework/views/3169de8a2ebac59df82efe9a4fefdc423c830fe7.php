    ...
    <div class="row"><br><br><br><br><br>
    	<div class="col-md-8 col-md-offset-2">
				                ...
				                <tr>
				                    ...
				                    <?php if($cartItem->options->size == 'small' || $cartItem->options->size == 'medium' || $cartItem->options->size == 'large'): ?>
					                    <td style="vertical-align:middle; text-align:center; width:80px">
					                        <div > 
					                        	<?php echo Form::select('size', ['small'=>'24 cm','medium'=>'32 cm','large'=>'45 cm'] , $cartItem->options->size); ?>
	        ...
	        <div class="col-md-6 col-md-offset-3" style="text-align:center">
                ...
                <h3><?php echo e(Form::label('oblast', 'Oblast')); ?></h3>
                <?php echo e(Form::select('oblast', $oblasti, null, ['class' => 'form-control','placeholder'=>'Odaberite oblast','onChange' => 'mojaFunkcija(this);'])); ?>
